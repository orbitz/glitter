...
module H = Hmm.Make(struct type s = Gene_prediction_2.coding_state type a = char let compare = compare end)
...
let td = Seq.to_list (Gene_prediction_2.create_training_data gene_boundaries fasta)
